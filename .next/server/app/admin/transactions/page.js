(()=>{var e={};e.id=4454,e.ids=[4454],e.modules={47849:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external")},72934:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external.js")},55403:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external")},54580:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external.js")},94749:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external")},45869:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},39491:e=>{"use strict";e.exports=require("assert")},6113:e=>{"use strict";e.exports=require("crypto")},82361:e=>{"use strict";e.exports=require("events")},57147:e=>{"use strict";e.exports=require("fs")},13685:e=>{"use strict";e.exports=require("http")},85158:e=>{"use strict";e.exports=require("http2")},95687:e=>{"use strict";e.exports=require("https")},71017:e=>{"use strict";e.exports=require("path")},12781:e=>{"use strict";e.exports=require("stream")},57310:e=>{"use strict";e.exports=require("url")},73837:e=>{"use strict";e.exports=require("util")},59796:e=>{"use strict";e.exports=require("zlib")},73313:(e,t,r)=>{"use strict";r.r(t),r.d(t,{GlobalError:()=>i.a,__next_app__:()=>p,originalPathname:()=>x,pages:()=>o,routeModule:()=>u,tree:()=>c});var s=r(50482),a=r(69108),l=r(62563),i=r.n(l),n=r(68300),d={};for(let e in n)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(d[e]=()=>n[e]);r.d(t,d);let c=["",{children:["admin",{children:["transactions",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(r.bind(r,41805)),"C:\\Users\\Download\\Documents\\razepag\\frontend\\app\\admin\\transactions\\page.tsx"]}]},{}]},{layout:[()=>Promise.resolve().then(r.bind(r,63243)),"C:\\Users\\Download\\Documents\\razepag\\frontend\\app\\admin\\layout.tsx"]}]},{layout:[()=>Promise.resolve().then(r.bind(r,78062)),"C:\\Users\\Download\\Documents\\razepag\\frontend\\app\\layout.tsx"],"not-found":[()=>Promise.resolve().then(r.t.bind(r,69361,23)),"next/dist/client/components/not-found-error"]}],o=["C:\\Users\\Download\\Documents\\razepag\\frontend\\app\\admin\\transactions\\page.tsx"],x="/admin/transactions/page",p={require:r,loadChunk:()=>Promise.resolve()},u=new s.AppPageRouteModule({definition:{kind:a.x.APP_PAGE,page:"/admin/transactions/page",pathname:"/admin/transactions",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:c}})},14456:(e,t,r)=>{Promise.resolve().then(r.bind(r,37039))},37039:(e,t,r)=>{"use strict";r.r(t),r.d(t,{default:()=>p});var s=r(95344),a=r(3729),l=r(5037),i=r(43617),n=r(29843),d=r(71532),c=r(97751),o=r(18117),x=r(91626);function p(){let[e,t]=(0,a.useState)(1),[r,p]=(0,a.useState)(""),[u,h]=(0,a.useState)(""),{data:y,isLoading:m}=(0,l.a)({queryKey:["admin-transactions",e,r,u],queryFn:()=>o.ZP.get("/admin/transactions",{params:{page:e,limit:25,type:r||void 0,status:u||void 0}}).then(e=>e.data.data),keepPreviousData:!0}),v=y?.transactions||[],k=y?.totalPages||1;return(0,s.jsxs)("div",{className:"space-y-6 animate-fade-in",children:[(0,s.jsxs)("div",{children:[s.jsx("h1",{className:"text-2xl font-bold text-white",children:"All Transactions"}),(0,s.jsxs)("p",{className:"text-gray-500 text-sm mt-1",children:[y?.total?.toLocaleString()||0," total transactions"]})]}),(0,s.jsxs)("div",{className:"flex flex-wrap gap-3",children:[(0,s.jsxs)("select",{value:r,onChange:e=>{p(e.target.value),t(1)},className:"bg-surface border border-border text-white px-4 py-2 rounded-xl text-sm focus:border-red-500/50 transition-all",children:[s.jsx("option",{value:"",children:"All Types"}),s.jsx("option",{value:"PIX_IN",children:"PIX In"}),s.jsx("option",{value:"PIX_OUT",children:"PIX Out"}),s.jsx("option",{value:"TRANSFER_IN",children:"Transfer In"}),s.jsx("option",{value:"TRANSFER_OUT",children:"Transfer Out"}),s.jsx("option",{value:"WITHDRAWAL",children:"Withdrawal"}),s.jsx("option",{value:"ADJUSTMENT",children:"Adjustment"})]}),(0,s.jsxs)("select",{value:u,onChange:e=>{h(e.target.value),t(1)},className:"bg-surface border border-border text-white px-4 py-2 rounded-xl text-sm focus:border-red-500/50 transition-all",children:[s.jsx("option",{value:"",children:"All Status"}),s.jsx("option",{value:"PENDING",children:"Pending"}),s.jsx("option",{value:"COMPLETED",children:"Completed"}),s.jsx("option",{value:"FAILED",children:"Failed"}),s.jsx("option",{value:"CANCELLED",children:"Cancelled"})]}),(r||u)&&s.jsx("button",{onClick:()=>{p(""),h(""),t(1)},className:"px-4 py-2 text-sm text-gray-400 hover:text-white border border-border rounded-xl transition-all",children:"Clear"})]}),s.jsx("div",{className:"bg-surface border border-border rounded-xl overflow-hidden",children:m?s.jsx("div",{className:"flex items-center justify-center py-12",children:s.jsx("div",{className:"w-6 h-6 border-2 border-red-500/30 border-t-red-500 rounded-full spinner"})}):(0,s.jsxs)(s.Fragment,{children:[s.jsx("div",{className:"overflow-x-auto",children:(0,s.jsxs)("table",{className:"w-full",children:[s.jsx("thead",{children:s.jsx("tr",{className:"border-b border-border",children:["User","Type","Amount","Fee","Status","Date"].map(e=>s.jsx("th",{className:"text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider",children:e},e))})}),s.jsx("tbody",{className:"divide-y divide-border",children:v.map(e=>(0,s.jsxs)("tr",{className:"table-row-hover",children:[s.jsx("td",{className:"px-5 py-3",children:(0,s.jsxs)("div",{children:[s.jsx("p",{className:"text-sm text-white",children:e.user?.name}),s.jsx("p",{className:"text-xs text-gray-600",children:e.user?.email})]})}),s.jsx("td",{className:"px-5 py-3",children:(0,s.jsxs)("div",{className:"flex items-center gap-2",children:[s.jsx("div",{className:`w-6 h-6 rounded-full flex items-center justify-center ${e.type.includes("IN")?"bg-green-500/10":"bg-red-500/10"}`,children:e.type.includes("IN")?s.jsx(i.Z,{className:"w-3 h-3 text-green-400"}):s.jsx(n.Z,{className:"w-3 h-3 text-red-400"})}),s.jsx("span",{className:"text-sm text-gray-300",children:x.KX[e.type]})]})}),s.jsx("td",{className:"px-5 py-3",children:s.jsx("span",{className:`text-sm font-medium ${(0,x.ks)(e.type)}`,children:(0,x.xG)(e.amount)})}),s.jsx("td",{className:"px-5 py-3",children:s.jsx("span",{className:"text-sm text-gray-500",children:(0,x.xG)(e.fee)})}),s.jsx("td",{className:"px-5 py-3",children:s.jsx("span",{className:`text-xs px-2 py-1 rounded-full ${(0,x.Ue)(e.status)}`,children:x.Gm[e.status]})}),s.jsx("td",{className:"px-5 py-3",children:s.jsx("span",{className:"text-xs text-gray-500",children:(0,x.p6)(e.createdAt)})})]},e.id))})]})}),k>1&&(0,s.jsxs)("div",{className:"flex items-center justify-between px-5 py-3 border-t border-border",children:[(0,s.jsxs)("p",{className:"text-xs text-gray-500",children:["Page ",e," of ",k]}),(0,s.jsxs)("div",{className:"flex gap-2",children:[s.jsx("button",{onClick:()=>t(e=>Math.max(1,e-1)),disabled:1===e,className:"p-1.5 rounded-lg border border-border disabled:opacity-30 hover:border-red-500/30 transition-all",children:s.jsx(d.Z,{className:"w-4 h-4 text-gray-400"})}),s.jsx("button",{onClick:()=>t(e=>Math.min(k,e+1)),disabled:e===k,className:"p-1.5 rounded-lg border border-border disabled:opacity-30 hover:border-red-500/30 transition-all",children:s.jsx(c.Z,{className:"w-4 h-4 text-gray-400"})})]})]})]})})]})}},43617:(e,t,r)=>{"use strict";r.d(t,{Z:()=>s});/**
